...
const int HCHO_window_size      = 180;
...
float CO_ppb               = 0.0;
float CO_zero              = 0.0;
const int CO_window_size   = 200;
const int CO_filter_size   = 1000;
...
void TVOCs_RecData() {
  ...
  if (ccs811.checkDataAndUpdate()) TVOCs_ugm3 = (float)ccs811.gettVOC() * 500 / 160;
